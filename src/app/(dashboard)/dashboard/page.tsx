  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 mt-6">
        {/* Kolom Kiri: Recent Activity Log & Traffic (60%) */}
        <div className="lg:col-span-6 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Trafik Akses Sistem (Minggu Ini)</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="h-[250px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={[
                    { name: 'Senin', users: 400, logins: 240 },
                    { name: 'Selasa', users: 300, logins: 139 },
                    { name: 'Rabu', users: 200, logins: 980 },
                    { name: 'Kamis', users: 278, logins: 390 },
                    { name: 'Jumat', users: 189, logins: 480 },
                    { name: 'Sabtu', users: 239, logins: 380 },
                    { name: 'Minggu', users: 349, logins: 430 },
        ...
        <div className="lg:col-span-4">
          <Card className="h-full">
            ...
            <CardContent className="space-y-4">
              <Link href="/konfigurasi/users?role=dosen" className="block w-full">
